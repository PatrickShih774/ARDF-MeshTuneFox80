...
| `pa-module` | 随底板插槽 | 3× BS170 并联、10kΩ+2.2kΩ 偏置分压、NTC 10kΩ B=3950、BZX84-C10 | E 类功放：漏极 12–13.8V，栅极偏置约 2.1V，输出 1–2.5W（峰值 3.5W/≤30s）；低功率档 0.02–0.5W 由 PWM 调升压模块实现 | 规划中 |
...
| `mcu-ui-module` | 随底板插槽 | ESP32-C3 SuperMini、12864 LCD（ST7588i，国产替代）、EC11 旋转编码器、双按键、蜂鸣器 | 主控、显示、参数调节、WiFi/NTP 校时、ESP-NOW Mesh | 规划中 |
