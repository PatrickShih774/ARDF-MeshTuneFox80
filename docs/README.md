...
| **16** | [**本地工作区与 DSH 设置（换会话交接）**](16-local-workspace-setup.md) | **★ 换工作区/换会话的唯一交接清单**：目录布局、迁移步骤、缓存代价、红线与陷阱 | ★ 操作权威 |
...
| [ADR-0004](adr/ADR-0004-lcd12864-on-shared-i2c.md) | 12864 液晶走 I2C 共享总线 | 已接受 |
