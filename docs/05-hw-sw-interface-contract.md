...
| 位 | 功能名 | 方向 | 说明 |
|----|--------|------|------|
| P0.0 – P0.5 | `IOEXP_RELAY_K1` … `K6` | O | **ATU 6 个继电器**，经 **ULN2003** 驱动 |
| P1.0 | `IOEXP_EC11_SW` | I | EC11 按键 |
| P1.1 – P1.7、P0.6 – P0.7 | `IOEXP_SPARE` | — | **预留 9 位** |
...
**扩展器承担**：6 继电器 + EC11 按键 = **7 / 16 位**，余 9 位。
